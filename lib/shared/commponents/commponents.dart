...
final RegExp emailValidatorRegExp = RegExp(
    r"^[a-zA-Z0-9.]([0-9a-zA-Z]*[-._+])*[0-9a-zA-Z]+@[a-zA-Z0-9]+\.[a-zA-Z]+");
            ...
            children: [
              Container(
                ...
                child: Image.network(
                    ...
                    'https://thumbs.dreamstime.com/t/k-loading-screen-black-line-white-background-animation-circle-ring-motion-graphic-141211116.jpg',
              ),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: SvgPicture.asset(
                              ...
                              color: inCart ? Colors.blue : Colors.grey[500],
                            ),
                          ),
                        ),
                      ],
...
Widget splashContentItem({@required textContent, @required image, flex = 2}) =>
    Column(
      children: [
        SizedBox(
...
Widget courseCardItem(item) => Padding(
      padding:
          EdgeInsets.symmetric(vertical: getProportionateScreenHeight(16.0)),
      child: Container(
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius:
              ...
              Column(
                ...
                children: [
                  Text(
                    'Total ratings',
                    style:
                        TextStyle(fontSize: getProportionateScreenWidth(8.0)),
                  ),
                  SizedBox(
...
void showToast({@required text, isError = false}) => Fluttertoast.showToast(
    ...
    fontSize: 16.0);
Widget profileCategoryItem({
  text,
}) =>
    Padding(
      padding: EdgeInsets.only(right: getProportionateScreenWidth(24.0)),
      child: Container(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          mainAxisAlignment: MainAxisAlignment.center,
